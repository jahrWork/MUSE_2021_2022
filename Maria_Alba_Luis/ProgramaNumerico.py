...
#### 1) Select the problem to integrate: Kepler_problem, Cauchy_problem or Linear_Oscillator
#### 2) Select initial condition, delta_t and N points
#### 3) Select the numerical scheme: Euler_forward, Euler_backward, CrankNicholson, RungeKutta4


########### Richardson extrapolation and N body problem shall be exectuted from the files named after them. 
