...
#### 1) elegir las condiciones iniciales del problema, así como tf (el numero de puntos no se toca, el mapa esta para eso)
#### 2) ESPERAR (tarda su ratito porque tiene que ejecutar los 4 esquemas)
